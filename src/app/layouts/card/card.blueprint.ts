...
export class Card {
    ...
    constructor(obj?: ICard) {
        ...
        this.imageUrl = obj.imageUrl || "https://jp.infragistics.com/angular-demos/assets/images/card/media/placeholder.jpg";
        this.avatarUrl = obj.avatarUrl || "https://jp.infragistics.com/angular-demos/assets/images/card/avatars/rupert_stadler.jpg";
